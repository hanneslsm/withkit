...
/**
 * Title: Layout-C-2
 * Slug: withkit/layout-c-2
 * Categories: withkit/layout-c
 * Viewport width: 1920
 */
?>
...
<!-- wp:paragraph -->
<p><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut vel turpis elementum, posuere dui eget, consectetur leo. Nulla sapien elit, consectetur ut porttitor ut, molestie vel sapien. Proin vitae suscipit risus, ac congue est. Integer interdum aliquet velit vel facilisis. Morbi vulputate pellentesque dolor vitae dapibus. ', 'withkit');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
